        ...
        <div class="row content">
            <div class="col-sm-3 sidenav">
                ...
                <ul class="nav nav-pills nav-stacked" id="dash-details">
                    ...
                    <li class="active"><a href="admin-view-feedback.php">View Feedback</a></li>
            ...
            <div class="col-sm-9">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<form class="box" method="post">';
                    echo '<td>
            <input type="hidden" name="delete_name" value="' . $row['feedback_id'] . '">
...
if (isset($_POST['delete_name'])) {
    ...
    $sql = "DELETE FROM tbl_feedback WHERE feedback_id = '$name_to_delete'";
    ...
    if (mysqli_query($con, $sql)) { ?>
        <script>
            Swal.fire(
                ...
                window.location.href = '/smit/admin-view-feedback.php';
            });
        </script> <?php
                } else {
