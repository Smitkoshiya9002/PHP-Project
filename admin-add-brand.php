...
<body>
        ...
        <div class="row content">
            <div class="col-sm-3 sidenav hidden-xs">
                ...
                <ul class="nav nav-pills nav-stacked" id="dash-details">
                    ...
                    <li class="active"><a href="admin-add-brand.php">Manage brand</a></li>
            ...
            <div class="col-sm-9">
                <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="add brand">Brand Name</label>
    ...
    if (isset($_POST['Add'])) {
        ...
        if ($numrows != 0) {
            echo "<script> alert('This brand is alerady available!') </script>";
            exit();
        } else {
            $insert = "INSERT INTO `tbl_brand`(`brand_name`) values ('$brand')";
            mysqli_query($con , $insert);
            echo "<script> alert('insert success!') </script>";
            echo '<script>location.href = "/smit/admin-add-brand.php";</script>';
            exit();
        }
    }
    ?>
...
<?php
    ...
    if (isset($_POST['Delete'])) {
        ...
        if ($numrows == 0) {
            echo "<script> alert('This brand is not available!') </script>";
            exit();
        } else {
            $insert = "delete from `tbl_brand` where `brand_name` = '$brand'";
            mysqli_query($con , $insert);
